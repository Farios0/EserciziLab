...
public final class TestSocialNetworkUser {
    ...
    public static void main(final String... args) {
        ...
        final SocialNetworkUser<User> mgladwell = new SocialNetworkUserImpl<>("Malcom", "Gladewell", "mgladwell", 51);
        ...
        dwashFriends.add(asmith);
            ...
            System.out.println("Operation Not supported, you can follow a user by using the addFollwedUser function");
        }
        /*
